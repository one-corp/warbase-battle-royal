...
const file_packets_proto_rawDesc = "" +
	"\n" +
	"\rpackets.proto\x12\awarbase\"\xe4\x02\n" +
	"\vClientEvent\x12?\n" +
	...
	"\tanimation\x18\b \x01(\tR\tanimation\"?\n" +
	"\bHitEvent\x12\x1b\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x14.warbase.PlayerStateR\x05value:\x028\x01\"\xf4\x01\n" +
	"\vPlayerState\x12\f\n" +
	"\x01x\x18\x01 \x01(\x02R\x01x\x12\f\n" +
	"\x01y\x18\x02 \x01(\x02R\x01y\x12\f\n" +
	"\x01z\x18\x03 \x01(\x02R\x01z\x12\x0e\n" +
	...
	"\ais_dead\x18\f \x01(\bR\x06isDead\"\x82\x02\n" +
	"\vServerEvent\x121\n" +
