...
const file_proto_packets_proto_rawDesc = "" +
	"\n" +
	"\x13proto/packets.proto\x12\awarbase\"\xe4\x02\n" +
	"\vClientEvent\x12?\n" +
...
func file_proto_packets_proto_init() {
	...
	file_proto_packets_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_proto_packets_proto_msgTypes[7].OneofWrappers = []any{
		(*ServerMessage_GameState)(nil),
		(*ServerMessage_ServerEvent)(nil),
	}
	file_proto_packets_proto_msgTypes[10].OneofWrappers = []any{
